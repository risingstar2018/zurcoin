...
const QString BITCOIN_IPC_PREFIX("zur:");
#ifdef ENABLE_BIP70
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/zur-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/zur-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/zur-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start zur: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("zur://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'zur://' is not a valid URI. Use 'zur:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // zurcoin: URI
    {
