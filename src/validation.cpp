...
#if defined(NDEBUG)
# error "Zurcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Zurcoin Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    // Subsidy is cut in half every 1500,000 blocks which will occur approximately every 4 years.
    nSubsidy >>= halvings;
    return nSubsidy;
}
