#!/usr/bin/env python3
# Copyright (c) 2018 The 123456 Core developers
...
class FilelockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        expected_msg = "Error: Cannot obtain a lock on data directory {}. Zurcoin Core is probably already running.".format(datadir)
