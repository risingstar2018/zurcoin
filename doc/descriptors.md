# Support for Output Descriptors in Zurcoin Core

Since Zurcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Zurcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Zurcoin Core wallets, a convenience function `combo` is
...
All RPCs in Zurcoin Core will include the checksum in their output. Only
