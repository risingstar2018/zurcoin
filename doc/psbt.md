# PSBT Howto for Zurcoin Core

Since Zurcoin Core 0.17, an RPC interface exists for Partially Signed Zurcoin
...
PSBT is an interchange format for Zurcoin transactions that are not fully signed
...
#### Multisig with multiple Zurcoin Core instances

Alice, Bob, and Carol want to create a 2-of-3 multisig address. They're all using
Zurcoin Core. We assume their wallets only contain the multisig funds. In case
