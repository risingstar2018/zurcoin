...
* Update manpages, see [gen-manpages.sh](https://github.com/zurcoin/zurcoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
* Update `src/chainparams.cpp` chainTxData with statistics about the transaction count and rate. Use the output of the RPC `getchaintxstats`, see
  [this pull request](https://github.com/zurcoin/zurcoin/pull/12270) for an example. Reviewers can verify the results by running `getchaintxstats <window_block_count> <window_last_block_hash>` with the `window_block_count` and `window_last_block_hash` from your output.
...
### Zurcoin maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Zurcoin Core for Linux, Windows, and macOS:
...
- Update zurcoin.org version
  ...
  - First, check to see if the Zurcoin.org maintainers have prepared a
    release: https://github.com/bitcoin-dot-org/zurcoin.org/labels/Core

      - If they have, it will have previously failed their Travis CI
        checks because the final release files weren't uploaded.
        Trigger a Travis CI rebuild---if it passes, merge.

  - If they have not prepared a release, follow the Zurcoin.org release
    instructions: https://github.com/bitcoin-dot-org/zurcoin.org/blob/master/docs/adding-events-release-notes-and-alerts.md#release-notes
...
- Update other repositories and websites for new version
  ...
  - zurcoin.org RPC documentation update
  ...
  - This repo
      ...
      - Create a [new GitHub release](https://github.com/zurcoin/zurcoin/releases/new) with a link to the archived release notes.
