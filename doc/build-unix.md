UNIX BUILD NOTES
====================
Some notes on how to build Zurcoin Core in Unix.

(For BSD specific instructions, see `build-*bsd.md` in this directory.)

Note
---------------------
Always use absolute paths to configure and compile Zurcoin Core and the dependencies.
...
memory available when compiling Zurcoin Core. On systems with less, gcc can be
...
To build Zurcoin Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Security
--------
To help make your Zurcoin Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Zurcoin Core should be built with a non-executable stack,
