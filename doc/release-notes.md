Zurcoin Core version 0.18.1 is now available from:

  <https://zurcoin.org/bin/bitcoin-core-0.18.1/>
...
`/Applications/Zurcoin-Qt` (on Mac) or `bitcoind`/`bitcoin-qt` (on
Linux).
...
Zurcoin Core is supported and extensively tested on operating systems
using the Linux kernel, macOS 10.10+, and Windows 7 and newer. It is not
recommended to use Zurcoin Core on unsupported systems.
...
10.10. Additionally, Zurcoin Core does not yet change appearance when
