Zurcoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/Zurcoin/bitcoin-0.8.4/
...
code, causing the Zurcoin-Qt or bitcoind process to crash.
...
their own version of Zurcoin against Boost versions 1.50-1.52.
