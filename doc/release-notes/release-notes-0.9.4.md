Zurcoin Core version 0.9.4 is now available from:
...
this update is incompatible with the Zurcoin system and could lead to consensus
forks.

Zurcoin Core released binaries from https://zurcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoin/+archive/ubuntu/bitcoin
- A third-party or self-compiled Zurcoin Core

upgrade to Zurcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
