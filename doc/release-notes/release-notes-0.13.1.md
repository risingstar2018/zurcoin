Zurcoin Core version 0.13.1 is now available from:

  <https://zurcoin.org/bin/bitcoin-core-0.13.1/>
...
In addition to that, with 0.12.x there have been varied reports of Zurcoin Core
...
- **Elimination of unwanted transaction malleability:** Segregating the witness
  ...
  malleability, which is a problem that makes programming Zurcoin wallet
  software more difficult and which seriously complicates the design of smart
  contracts for Zurcoin.
...
- **Weighting data based on how it affects node performance:** Some parts of
  each Zurcoin block need to be stored by nodes in order to validate future
...
- **Increased security for multisig:** Zurcoin addresses (both P2PKH addresses
  ...
  believed to be provided by Zurcoin's choice of parameters for its Elliptic
  Curve Digital Security Algorithm [ECDSA].)

- **More efficient almost-full-node security** Satoshi Nakamoto's original
  Zurcoin paper describes a method for allowing newly-started full nodes to
  skip downloading and validating some data from historic blocks that are
  protected by large amounts of proof of work.  Unfortunately, Nakamoto's
  method can't guarantee that a newly-started node using this method will
  produce an accurate copy of Zurcoin's current ledger (called the UTXO set),
  ...
  note that Zurcoin Core does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  Zurcoin users to individually opt-in to almost any change in the Zurcoin
  Script language when those users receive new transactions.  Features
  currently being researched by Zurcoin Core contributors that may use this
  capability include support for Schnorr signatures, which can improve the
  privacy and efficiency of multisig transactions (or transactions with
  multiple inputs), and Merklized Abstract Syntax Trees (MAST), which can
  improve the privacy and efficiency of scripts with two or more conditions.
  Other Zurcoin community members are studying several other improvements
...
[Segwit FAQ]: https://zurcoin.org/en/2016/01/26/segwit-benefits/
[segwit wallet developers guide]: https://zurcoin.org/en/segwit_wallet_dev/
[BIP141]: https://github.com/bitcoin/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/bitcoin/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/bitcoin/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/bitcoin/bips/blob/master/bip-0145.mediawiki
[versionbits FAQ]: https://zurcoin.org/en/2016/06/08/version-bits-miners-faq/
...
Since Zurcoin Core 0.10.0, nodes have defaulted to only relaying and
