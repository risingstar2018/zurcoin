Zurcoin Core version *0.15.1* is now available from:

  <https://zurcoin.org/bin/bitcoin-core-0.15.1/>
...
A number of changes to the way Zurcoin Core deals with peer connections and invalid blocks
