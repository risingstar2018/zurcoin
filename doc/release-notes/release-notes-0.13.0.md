Zurcoin Core version 0.13.0 is now available from:

  <https://zurcoin.org/bin/bitcoin-core-0.13.0/>
...
Various code modernizations have been done. The Zurcoin Core code base has
...
HD wallets are incompatible with older versions of Zurcoin Core.

[Pull request](https://github.com/zurcoin/zurcoin/pull/8035/files), [BIP 32](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)
...
proposed parameters, a future release of Zurcoin Core is expected that
...
The two phases are distinct in the Zurcoin-Qt GUI. During the first one,
...
- #8207 `f7a403b` Add a link to the Zurcoin-Core repository and website to the About Dialog (MarcoFalke)
...
- #8164 `0f24eaf` [Zurcoin-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
