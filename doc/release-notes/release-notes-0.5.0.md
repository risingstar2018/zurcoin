Zurcoin version 0.5.0 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Zurcoin/bitcoin-0.5.0/
...
For Ubuntu users, there is a new ppa maintained by Matt Corallo which you can add to your system so that it will automatically keep bitcoin up-to-date.  Just type "sudo apt-add-repository ppa:zurcoin/zurcoin" in your terminal, then install the bitcoin-qt package.
...
If you have a previously encrypted wallet.dat, the first time you run bitcoin-qt or bitcoind the wallet will be rewritten, Zurcoin will
