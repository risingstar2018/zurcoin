...
def setup():
    ...
    if not os.path.isdir('bitcoin'):
        subprocess.check_call(['git', 'clone', 'https://github.com/zurcoin/zurcoin.git'])
...
def build():
    ...
    subprocess.check_call(['wget', '-N', '-P', 'inputs', 'https://zurcoin.org/cfields/osslsigncode-Backports-to-1.7.1.patch'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/zurcoin/zurcoin', help='Specify the URL of the repository. Default is %(default)s')
